...
-- insert into paymentinformationown values ('2', '5587847357636285', '2908  Lynden Road', '0521', '549');
...
-- insert into videoupload (userid, videoname, videoview, videolength, videogenre) values ('5', 'Ricky Gervais Stand Up ','267221', '3:14', 'comedy');
...
-- -- ReportCreate
-- insert into reportcreat (userid, status, decision, reportdate, reason) values ('2', 'pending', '', '2017-03-19', 'inappropriate language');
